...
Na wykresie \ref{cec-17} przedstawione są uzyskane wyniki. Standardowa wersja algorytmu \texttt{CMA-ES} przewyższa wszystkie inne
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 0.9\textwidth]{./media/cec-17-13.png}
\end{centering}
